...
// Función principal de paginación - MODIFICADA para mostrar numeración solo desde página 2
function pagination(totalPosts) {
    ...
    // NUEVA LÓGICA: Solo mostrar numeración si estamos en página 2 o superior
